...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url('auth/login'); ?>"><b>indah 2</b></a>
        </div>
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="row">
                    ...
                    <p class="mt-3 mb-0">Don't have an account? <a href="<?php echo base_url('auth/register'); ?>" class="text-center">Register</a></p>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
