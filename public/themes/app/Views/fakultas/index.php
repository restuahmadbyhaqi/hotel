...
<div class="row mb-2">
<div class="col-sm-6">
<h1 class="m-0 text-dark">Fakultas Universitas
Muhammadiyah Magelang</h1>
</div>
<div class="col-sm-6">
...
<a href="<?php echo base_url('fakultas/create');
...
<td>
<div class="btn-group">
<a href="<?php echo base_url('fakultas/edit/'.$row['fak_id']);
?>" class="btn btn-sm btn-success">
<i class="fa fa-edit"></i>
</a>
<a href="<?php echo base_url('fakultas/delete/'.$row['fak_id']);
